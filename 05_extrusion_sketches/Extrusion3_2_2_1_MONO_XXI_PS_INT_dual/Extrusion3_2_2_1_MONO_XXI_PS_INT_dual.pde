/**
 * Extrusion. LSystem — RAND SYSTEM A (dual / neat stacking)
...
public void setup()
{
  ...
  sendername = "Extrusion3_2_2_1_MONO_XXI_PS_INT_dual";
  noFill();
  loop();
...
void draw()
{
  ...
  translate(width/720, 474, 221);
  rotateZ(theta-TAU-QUAD);
  rotateY(theta/TAU-QUAD);
  rotateX(TAU-CENTER);
  frameRate(60);
